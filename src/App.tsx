...
export default function App() {
  ...
  const [settingsInitialTab, setSettingsInitialTab] = useState<SettingsTab>('factory');
  ...
  return (
    ...
    >
      ...
      <SettingsModal
        ...
        factoryProfile={factoryProfile}
        onUpdateFactoryProfile={setFactoryProfile}
        savedFactories={savedFactories}
        onSaveFactoryList={setSavedFactories}
      />
